...
<section class="bg-white py-20 z-50 relative">
    <h2 id="galeria" class="text-center font-simonetta uppercase text-3xl mb-12 text-pink-800
                            font-black">Momentos Inolvidables</h2>
    ...
    <h3 class="mt-8 text-center text-neutral-600 text-3xl italic font-light font-nanum max-w-2xl mx-auto">Puedes compartir con nosotros las fotos que tomes en la boda usando el hashtag:</h3>
